...
from model import GolferTournamentDetails
...
def get_golfers_tournament_details(golfers_tournament_details_id):
    ...
    golfer_tournament_details_data = golfers_tournament_details_collection.find_one({"_id": ObjectId(golfers_tournament_details_id)})
...
@golfers_tournament_details_bp.route('/golfers_tournament_details/golfer/<golfer_id>', methods=['GET'])
def get_all_tournament_details_by_golfer(golfer_id):
    ...
    all_golfers_tournament_details_data = golfers_tournament_details_collection.aggregate([
        {
            "$match": {
