...
from flask_app.models import Draft, DraftPick, Team, League
...
test_league_obj = League(**test_league)

test_league_obj.create_periods_between_tournaments()
...
# for st in sorted_tournaments:
#     associated_tourney = db.tournaments.find_one({
#         "_id": st
#     })

#     print(associated_tourney["Name"])
